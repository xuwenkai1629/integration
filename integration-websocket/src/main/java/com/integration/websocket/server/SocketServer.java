package com.integration.websocket.server;

import com.integration.websocket.entity.Client;
 ...
 * date: 2020/7/16
 */
@ServerEndpoint(value = "/socketServer/{unitId}/{userName}")
@Component
public class SocketServer {
    ...
    public void onMessage(String message) {
        ...
        sendMessage( message, SYS_USERNAME);
